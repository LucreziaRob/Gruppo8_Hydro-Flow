...
<head>
  ...
  <title>Hydro-Flow - Conferma inoltro questionario</title>
      ...
      <div class="row">
        <div class="col-md-12 column">
          <div class="error-page">
            <h1 style="font-size: 100px">SU<i>CCE</i>SSO </br> <span style="font-size: 50px">LA TRADUZIONE È AVVENUTO CON SUCCESSO!</span></h1>
            <span>Grande!</span>
            <p>La traduzione del sito nella lingua selezionata è avvenuta!</p>
            <i style="font-size: x-large">Clicca <a href="index.jsp" style="color: #4e8ce1">qui</a> per tornare alla HomePage tradotta</i>
            <div></div>
          </div>
        </div>
      </div>
