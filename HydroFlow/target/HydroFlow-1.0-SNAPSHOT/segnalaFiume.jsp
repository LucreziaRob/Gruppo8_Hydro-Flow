                    ...
                    <div class="col-md-offset-2 col-md-8 column">
                        ...
                        <form  class="contact-form" method="post" action="contact.php" name="contactform" id="contactform">
                            <div class="row">
                                ...
                                <div class="col-md-12"><label name="name" type="text" placeholder="Nome fiume" /><select class="js-example-basic-single" name="nomi" id="email" style="background-color: white; width: 770px; height: 50px">
