...
<div class="theme-layout">
    ...
    <div class="page-top">
        <div style="background:url(images/info.png);background-position: bottom;" class="parallax"></div>
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 column">
                    <div class="single-post">
                        ...
                        <p>La prerogativa di questa pagine è quella di illustrare e spiegare all'utente come raccogliere
                            in modo sicuro e senza contaminazioni l'acqua del fiume. Anche l'utente meno abile sarà
                            capace di
                        ...
                        <p>La prerogativa di questa pagine è quella di illustrare all'utente i contatti di tutte le
                        ...
                        <p>La prerogativa di questa pagine è quella di fornire all'utente una serie di domande, alle
                            quali è libero di rispondere oppure no,
                            tramite le quali potrà stilare una prima analisi del campione raccolto. </p>
                        ...
                        <p>La prerogativa di questa pagine è quella di concedere all'utente di aggiungere foto del fiume al sito
                        ...
                        La prerogativa di questa pagine è quella di fornire all'utente un modo, semplice e veloce, per segnalare un fiume,
                        senza entrare in prima persona nella risoluzione del problema.</p>
                        <blockquote> Le associazioni prenderanno in carico la tua richiesta e verificheranno la veridicità della segnalazione!</blockquote>
                        <p>Una volta inoltrato
                            la richiestra verrà
