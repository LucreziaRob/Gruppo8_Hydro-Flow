...
<head>
  ...
  <title>Hydro-Flow - Conferma inoltro segnalazione</title>
      ...
      <div class="row">
        <div class="col-md-12 column">
          <div class="error-page">
            <h1 style="font-size: 100px">SU<i>CCE</i>SSO </br> <span style="font-size: 50px">L'INOLTRO È AVVENUTO CON SUCCESSO!</span></h1>
            <span>Grande!</span>
            <p>La segnalazione è stata inoltrata al nostro team e verrà presto elaborata!</p>
