...
<head>
  ...
  <title>Hydro-Flow - Analisi campione</title>
...
<div class="theme-layout">
              ...
              <div class="tp-banner">
                <ul>
                  <li data-transition="zoomout" data-slotamount="10" data-masterspeed="1000" >
                    <img src="images/compilaAnalisi.jpg"  alt="slidebg3"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                    <div class="tp-caption sfb slide-title" data-x="center" data-y="330" data-speed="500" data-start="1400" data-easing="Back.easeOut" data-captionhidden="on" style="font-size:80px;">COMPILA ANALISI</div>
                   </li><!-- Slide 1 -->
          ...
          <div class="col-md-offset-2 col-md-8 column">
            ...
            <form  class="contact-form" method="post" action="contact.php" name="contactform" id="contactform">
              <div class="row">
                ...
                <div class="col-md-6"><input type="text" /></div>
                <div class="col-md-6"><label>Sono presenti nitriti? Quanti?</label></div>
                <div class="col-md-6"><input type="text" /></div>
                <div class="col-md-6"><label>Sono presenti nitrati? Quanti?</label></div>
                <div class="col-md-6"><input type="text" /></div>
                <div class="col-md-6"><label>È presente ferro? Quanto?</label></div>
                <div class="col-md-6"><input type="text" /></div>
                <div class="col-md-6"><label>È presente fauna?</label></div>
                <div class="col-md-6"><input type="text" /></div>
                <div class="col-md-6"><label>È presente flora?</label></div>
                <div class="col-md-6"><input type="text" /></div>
  ...
  <footer>
    <div class="block">
      <div class="parallax" style="background:url(images/compilaAnalisi.jpg);"></div>
      <div class="container">
        <div class="row">
